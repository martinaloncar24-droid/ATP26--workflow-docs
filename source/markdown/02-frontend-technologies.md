...
- See also
- Prerequisites
**There is no prerequisite knowledge for starting this course.** 
Also note that we don't consider learning these topics as required before moving on to the Core modules, 
> but we believe students will have an easier time if they spend some time on these topics first.
...
Prerequisites:  Basic familiarity with your computer operating system (OS).
Learning outcomes:  
...
For now, we would recommend that you install Visual Studio Code, as it is available across different platforms, has a great feature set and support, and is the editor we mostly use. You should install this now to follow along with the rest of this article.
...
# slikee
slika br.2![<../assets images/pexels-pixabay-270348.jpg>)](<../../assets/images/pexels-pixabay-248515 (1).jpg>))
[link za sliku br.1](https://images.pexels.com/photos/248515/pexels-photo-248515.png)

slika br.2![!\[!\\[<../assets images/pexels-pixabay-270348.jpg>)\\](<../../assets/images/pexels-pixabay-270348 copy.jpg>)\](../../assets/images/pexels-pixabay-270348.jpg)](../../assets/images/pexels-punttim-52608.jpg))
[link za sliku br.2](https://images.pexels.com/photos/52608/pexels-photo-52608.jpeg)


## tablice

| Ekstenzija | Namjena | Preporuka |
|-----------|---------|-----------|
| Prettier | Formatiranje koda | Da |
| Live Server | Lokalni server | Da |
| ESLint | Analiza koda | Da |
| GitLens | Git alati | Opcionalno |

### link na izvore
- https://developer.mozilla.org/en-US/docs/Learn_web_development/Getting_started/Environment_setup/Installing_software

### task lista
- [x] Definirati ideju projekta
- [x] Napraviti strukturu foldera
- [ ] Izraditi HTML strukturu
- [ ] Dodati CSS stilove
- [ ] Implementirati JavaScript logiku
